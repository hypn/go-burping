...
supported_versions_to_bytes = {
    "6": [
        ...
        [b"\xfb\x00\x0f\x85\x96\x00\x00\x00", b"\xfb\x00\x0f\x84\x96\x00\x00\x00"],  # "handshake did not verify certificate chain"
    ],
    "7": [
        [b"\x84\xff\x0f\x84\x5a\x01\x00\x00", b"\x84\xff\x0f\x85\x5a\x01\x00\x00"],  # "certificate signed by unknown authority"
        [b"\x84\xc9\x0f\x84\x5f\x01\x00\x00", b"\x84\xc9\x0f\x85\x5f\x01\x00\x00"],  # "handshake did not verify certificate chain"
    ],
    "8": [
    ...
    "9": [
        [b"\x84\xc0\x0f\x85\x67\x1c\x00\x00", b"\x84\xc0\x0f\x84\x67\x1c\x00\x00"],  # "certificate signed by unknown authority"
        [b"\x84\xc9\x0f\x84\xc5\x01\x00\x00", b"\x84\xc9\x0f\x85\xc5\x01\x00\x00"],  # "handshake did not verify certificate chain"
    ],
    "10": [
        [b"\x84\xc9\x0f\x85\xbd\x1a\x00\x00", b"\x84\xc9\x0f\x84\xbd\x1a\x00\x00"],  # "certificate signed by unknown authority"
        [b"\x84\xc9\x0f\x84\xac\x01\x00\x00", b"\x84\xc9\x0f\x85\xac\x01\x00\x00"],  # "handshake did not verify certificate chain"
    ],
